...
See [S3 Key Patterns](/data-contract/s3-key-patterns/) and [Parquet Output](/data-contract/parquet-output/).
...
- Query data via [REST API](/verification/rest-api/)
- Visualize in the [Portal](/verification/portal/)
