...
- [Terraform Init](/deploy/terraform-init/) completed
- [ECR image mirrored](/deploy/ecr-processor-image/)
...
Deploy the portal manually — see [Amplify Portal](/deploy/amplify-portal/).
...
<Aside type="tip">
  After full apply, run [CORS Lockdown](/deploy/cors-lockdown/) so the hosted
  portal can call the API from the browser.
</Aside>
...
See [Terraform Outputs](/reference/terraform-outputs/) for all output values.

## Next steps

- [Amplify Portal](/deploy/amplify-portal/) — confirm portal deployment
- [Verification](/verification/eventbridge-scheduler/) — end-to-end checks
